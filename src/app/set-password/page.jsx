        ...
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <div className="grid gap-5">
            <div className="grid gap-2">
              <Field type="text" placeHolder={'New Password'} className={`min-w-full rounded-[10rem] px-5`} />
            </div>
            <div className="grid gap-2">
              <Field type="text" placeHolder={'Re-Enter New Password'} className={`min-w-full rounded-[10rem] px-5`} />
            </div>
